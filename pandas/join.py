...
result = df_students.merge(df_courses , on ="student_id" ,  how='left')
result  = result.merge(df_fees, on="student_id", how="left")
result = result.merge(df_attendance, on="student_id",how="left")
print(result)